...
var valores = []//vetor de valores vazio 
...
function adicionar() {
    if(isNumero(num.value) && !inLista(num.value, valores)) {
        ...
        res.innerHTML = ''//serve para 'limpar' o que ele foi ordenado a fazer
    }else {
        window.alert('O valor é invalido ou ja se encontrra na lista')
    }
    num.value = ''
    num.focus()
}
